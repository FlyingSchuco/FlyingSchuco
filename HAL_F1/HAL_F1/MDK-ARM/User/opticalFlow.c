...
{
	//锁定帧率
	uint8_t config = ReadReg(0x0b);
	WriteReg(0x0b,config|1,AUTO);

    uint8_t lower = (uint8_t)(24000000/FrameRate);
    uint8_t upper = (uint8_t)((24000000/FrameRate)>>8);
	if(ReadReg(0x0b)>>7==0)
	{
