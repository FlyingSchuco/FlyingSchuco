...
HAL_StatusTypeDef MPU_Write_Len(uint8_t addr,uint8_t reg,uint8_t len,uint8_t *buf);//IIC连续写
HAL_StatusTypeDef MPU_Read_Len(uint8_t addr,uint8_t reg,uint8_t len,uint8_t *buf); //IIC连续读 
...
#ifdef _USE_MPU6050
#define MPU_RST 0x52
#define MPU_FAST 0x63	//100Hz
#define MPU_SLOW 0x64	//20Hz
enum SPEED
{
	FAST,	//100Hz
	SLOW	//20Hz
